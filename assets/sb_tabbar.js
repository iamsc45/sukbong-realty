...
(function(){
  ...
  var MENU=[
    ...
    {g:'콘텐츠',items:[
      ...
      /* 🔴 2026-08-20 석봉님 지적으로 추가 — 「모바일에는 땅값 기능이 없는데?」
         땅값은 2026-08-13 개통인데 이 메뉴가 2026-08-10 신설이라, **만들면서 진입로를
         안 넣었다.** 데스크톱 상단 nav 에만 있어서 모바일에서는 주소를 직접 치지 않으면
         닿을 수 없었다. 새 화면을 만들면 여기에도 넣을 것.
  ...
  /* 🔴 이 목록을 밖으로 내보낸다(2026-08-22 석봉님 지적 「전체메뉴가 정리가 하나도 안 되어 있네」).
     모바일 메뉴가 **세 곳에 따로** 적혀 있어 서로 어긋나 있었다 —
       ①하단 탭바 전체 메뉴(여기, 18개) ②홈 햄버거 패널(14개) ③홈 허브 타일(12개).
